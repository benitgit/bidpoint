...
<table class="table" id="mytable">
	...
	table of all registered products for auctions
	-->
		...
		while($row = mysql_fetch_object($list))
		{
			...
			<tr>
				...
				<td><?=$row->pdate?></td>
				<td><?php
						echo getdays(date("Y-m-d"),$row->pdate);
						echo " <span class='numbers'>Days Left ...</span>";
					?></td>
				<td><?=$row->minbid?></td>
				<td>
...
<a href="new_auction.php"><button class="btn btn-primary">Add New Product</button></a>
</div>
 </body>
 </html>